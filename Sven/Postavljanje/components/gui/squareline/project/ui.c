...
void ui_event_DijagnostikaBTN(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_RELEASED) {
        _ui_screen_change(&ui_Dijagnostika, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_Dijagnostika_screen_init);
    }
}
void ui_event_main_display_button(lv_event_t * e)
{
...
void ui_event_Button9(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_RELEASED) {
        _ui_screen_change(&ui_LEDtest, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_LEDtest_screen_init);
    }
}
void ui_event_BACK(lv_event_t * e)
{
...
void ui_init(void)
{
    ...
    ui_LEDtest_screen_init();
    ui_Dijagnostika_screen_init();
